...
settings.particles = int(1000000)
settings.batches = 10
...
materials.cross_sections = "/mnt/e/endfb-viii.0-hdf5/cross_sections.xml"
...
cyl_mesh = openmc.CylindricalMesh(mesh_id=3)
cyl_mesh.r_grid = np.linspace(0, 275*2)
cyl_mesh.z_grid = np.linspace(0, 260*4, 260)
...
photon_flux.filters = [cyl_mesh_filter, openmc.ParticleFilter('photon')]
...
strict_fast_flux.filters = [cyl_mesh_filter, openmc.EnergyFilter([1.0e6 ,20.0e6]), openmc.ParticleFilter('neutron')]
...
multiplying_flux.filters = [cyl_mesh_filter, openmc.EnergyFilter([5e6 ,20.0e6]), openmc.ParticleFilter('neutron')]
...
local_heat_load.filters = [cyl_mesh_filter]
...
helium_mesh.filters = [cyl_mesh_filter]
...
inverse_velocity_mesh.filters = [cyl_mesh_filter, openmc.ParticleFilter('neutron')]
